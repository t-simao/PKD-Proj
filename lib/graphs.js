...
exports.lg_dfs_visit_order_reverse = lg_dfs_visit_order_reverse;
exports.mg_dfs_visit_order = mg_dfs_visit_order;
exports.wg_new = wg_new;
exports.wg_from_edges = wg_from_edges;
...
function lg_dfs_visit_order_reverse({ adj, size }, restart_order = null) {
    ...
    function dfs_visit(current) {
        if (colour[current] === white) {
            ...
            (0, list_1.for_each)(dfs_visit, adj[current]);
            colour[current] = black;
            result = (0, list_1.append)(result, (0, list_1.list)(current));
        }
        else { }
    }
    (0, list_1.for_each)(dfs_visit, restart_order);
    return (0, list_1.reverse)(result);
}
/**
...
// Helper functions
function wg_new(size) {
    return { size, adj: build_array(size, _ => null) };
}
function wg_from_edges(size, weightedEdges) {
    const result = wg_new(size);
    while (weightedEdges != null) {
        const bond = (0, list_1.head)(weightedEdges);
        const weight = (0, list_1.tail)(bond);
        const edg = (0, list_1.head)(bond);
        result.adj[(0, list_1.head)(edg)] = (0, list_1.append)(result.adj[(0, list_1.head)(edg)], (0, list_1.list)((0, list_1.pair)((0, list_1.tail)(edg), weight)));
        result.adj[(0, list_1.tail)(edg)] = (0, list_1.append)(result.adj[(0, list_1.tail)(edg)], (0, list_1.list)((0, list_1.pair)((0, list_1.head)(edg), weight)));
        weightedEdges = (0, list_1.tail)(weightedEdges);
    }
    return result;
}
