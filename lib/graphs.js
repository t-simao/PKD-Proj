...
exports.SSC_split = SSC_split;
var list_1 = require("../lib/list");
var queue_array_1 = require("../lib/queue_array");
var scc_1 = require("../week10/scc");
// Helper functions
/**
...
function SSC_split(lg) {
    var scc = (0, scc_1.lg_kosaraju)(lg);
    var res = null;
    while (!(0, list_1.is_null)(scc)) {
        var temp = lg_restrict(lg, (0, list_1.head)(scc));
        res = (0, list_1.pair)(temp, res);
        scc = (0, list_1.tail)(scc);
    }
    return res;
}
