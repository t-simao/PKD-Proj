...
console.log("------------------------- PATH -------------------------");
shortest_path(map_1.map, "Entrance", "Library");
console.log("------------------------- PATH -------------------------");
shortest_path(map_1.map, "Library", "Café");
console.log("------------------------- PATH -------------------------");
shortest_path(map_1.map, "Entrance", "Lounge");
console.log("------------------------- PATH -------------------------");
shortest_path(map_1.map, "Entrance", "ConferenceRoom", true);
console.log("------------------------- PATH -------------------------");
shortest_path(map_1.map, "Library", "Library");
console.log("------------------------- PATH -------------------------");
shortest_path(map_1.map, "Moon", "Library");
