...
exports.map = exports.Pathway_const = void 0;
...
function make_edge(to, type) {
    var Weight = exports.Pathway_const[type];
    return {
        to: to.id,
        type: type,
        weight: Weight
...
function add_edge(map, from, type, to) {
    ...
    if (src === undefined || dst === undefined || path_exist(map, src, dst))
        return;
